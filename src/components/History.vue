<template>
  <div class="hist">
    ...
    <div id="view">
      <div class="block">
        <div class="alert alert-primary text_c" role="alert">各家持有手牌</div>
        <div id="handCards"></div>
      </div>
      <div class="block">
        <div class="alert alert-primary text_c" role="alert">遊戲歷程</div>
        <pre id="history"></pre>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    getString(data) {
      return (
        ["\u{2660}", "\u{2665}", "\u{2663}", "\u{2666}"][data.suit - 1] +
